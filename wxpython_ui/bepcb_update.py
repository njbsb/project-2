...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"BePCB Report - Split", pos = wx.DefaultPosition, size = wx.Size( 500,300 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		
		self.SetSizeHintsSz( wx.DefaultSize, wx.DefaultSize )
		
		bSizer2 = wx.BoxSizer( wx.VERTICAL )
		
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"BePCB Report - Split", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2.Wrap( -1 )
		self.m_staticText2.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), 75, 90, 90, False, "Century Gothic" ) )
		...
		self.m_button5 = wx.Button( self, wx.ID_ANY, u"Select file", wx.Point( -1,-1 ), wx.DefaultSize, 0 )
		self.m_button5.SetFont( wx.Font( 9, 74, 90, 90, False, "Century Gothic" ) )
		
		bSizer2.Add( self.m_button5, 0, wx.ALIGN_CENTER|wx.ALL, 5 )
		
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, u"file_name.pdf", wx.DefaultPosition, wx.DefaultSize, 0 )
